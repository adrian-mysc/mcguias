# Gabarito — Prova para Supervisor/Aspirante

> Tempos, validades e padrões operacionais. Respostas validadas contra o conteúdo
> do app (`data/questions/`) e contra as embalagens fotografadas.
> Legenda: ✅ confirmado · 🟡 confirmar no padrão atual da loja.

## Tempos de vida / validades primárias

| # | Pergunta | Resposta | Status |
|---|----------|----------|:---:|
| 1 | Vida primária das carnes **10:1 e 4:1** | **90 dias e 90 dias** (Regular e Quarterão) | ✅ |
| 2 | Vida primária do **queijo fatiado** | **120 dias** (lacrado/congelado) | ✅ |
| 3 | Vida dos **pães congelados e frescos** | **120 dias** (congelado) e **48 horas** (descongelado/fresco) | ✅ |
...
| # | Pergunta | Resposta | Status |
|---|----------|----------|:---:|
| 30 | **Atributos de qualidade** dos produtos | **Temperatura, Sabor e Aparência** | ✅ |
| 31 | Declaração de **Cultura/Identidade** | **Fazemos as coisas Simples, Juntos e com Paixão** | ✅ |
| 32 | Ano em que **Ray Kroc** abriu o 1º restaurante | **1955** (15 de abril de 1955) | ✅ |
| 33 | Papel do **Treinador** na integração de novo membro | Treinar seguindo padrões/materiais, acompanhar o desempenho e dar **feedback constante** | ✅ |
| 34 | **Benefícios** de ter funcionários treinados | Pergunta aberta | 🟡 |
| 35 | **Princípios da Cultura de Serviço** | Generosidade, Humildade, Vocação em servir, Inclusão… | 🟡 confirmar lista |
| 36 | Os "**3 Os**" da operação | Não consta no app (possível erro de transcrição) | 🟡 |
| 37 | Um dos 3 **Styles** do programa Influencer Vendedor | App não detalha os 3 | 🟡 |
